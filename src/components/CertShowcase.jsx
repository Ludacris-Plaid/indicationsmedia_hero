...
const certs = [
  ...
  },
  {
    ...
    color: '#9B4F96',
    accent: '#B97DBC',
    description: '.NET development, object-oriented programming, and enterprise applications.',
  ...
  },
  {
    ...
    color: '#0DB7ED',
    accent: '#3DC9F1',
    description: 'CI/CD, infrastructure as code, containerization, and orchestration.',
